...
//        if (mActivity instanceof WelcomeViewPagerActivity) {
//            if (arg1 == mViews.size() - 1) {
//                Button btn = (Button) arg0.findViewById(R.id.iv_start_weibo);
...
//        editor.commit();
        try {
            ...
            XCDSharePreference.getInstantiation(mActivity).setSharedPreferences("FRISTVERSIONNAME",versionName);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

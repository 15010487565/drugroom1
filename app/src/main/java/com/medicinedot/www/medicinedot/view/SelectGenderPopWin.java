...
public class SelectGenderPopWin extends PopupWindow {
    ...
    public SelectGenderPopWin(Context mContext, RadioGroup.OnCheckedChangeListener itemsOnClick,String gender) {
        ...
        // 设置按钮监听
        radioGroupID.setOnCheckedChangeListener(itemsOnClick);
        // 设置外部可点击
